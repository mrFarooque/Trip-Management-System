...
public class CustomerController {
	...
	@Autowired
	CBookingService bookingService;
	@Autowired
	...
	public ResponseEntity<Booking> createBooking(@RequestBody BookingDTO bookingDTO,
			@PathVariable("id") Integer customerId) throws PackageException, CustomerException {
	...
	public ResponseEntity<List<Feedback>> getFeedbacks(@PathVariable Integer id)
